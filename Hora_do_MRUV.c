 ...
 void menu_mruv(x)
{
    ...
    fflush(stdin);
    printf("\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\");
    printf("\n   MOVIMENTO RETILÕNEO UNIFORMEMENTE VARIADO");
    printf("\n\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\");
    ...
    switch(menu)
    {
        case 1:
            do{
                ...
                printf("\n\nA ACELERA«√O foi de: %.3f m/s^2", aceleracao);
                printf("\nF”RMULA: a = (Vf - Vi) / (tf - ti)\n"); //         a = ‚àÜV / ‚àÜt\n

                fflush(stdin);
                printf("\nDeseja calcular uma nova ACELERA«√O?(s/n) ");
        ...
        case 4:
            do{
                ...
                printf("\n\nA POSI«√O FINAL foi de: %.3f m", posicao_final);    //conferir se o resultado est√° certo
                printf("\nF”RMULA: S = Si + Vi * t + 1/2 * a * t^2\n");        //

                fflush(stdin);
                printf("\nDeseja calcular uma nova POSI«√O FINAL?(s/n) ");
        ...
        case 5:
            do{
                ...
                printf("\n\nA POSI«√O INICIAL foi de: %.3f m", posicao_inicial);//conferir se o resultado est√° certo
                printf("\nF”RMULA: Si = S - Vi * t + 1/2 * a * t^2\n");

                fflush(stdin);
                printf("\nDeseja calcular uma nova POSI«√O INICIAL (s/n) ");
        ...
        case 6:
            do{
                ...
                printf("\n\nO TEMPO foi de: %.3f m", tempo);//conferir se o resultado est√° certo
                printf("\nF”RMULA: t = (Vf - Vi) / a\n");
